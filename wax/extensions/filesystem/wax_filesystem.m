...
{
    lua_pushstring(L, [NSHomeDirectory() UTF8String]);
    return 1;
}
static int docPath(lua_State *L)
{
    NSString *docPath=[NSHomeDirectory() stringByAppendingPathComponent:@"Documents"];
    lua_pushstring(L, [docPath UTF8String]);
    return 1;
}
static int savaPath(lua_State *L)
{
    NSString *docPath=[NSHomeDirectory() stringByAppendingPathComponent:@"Library/Caches/course"];
